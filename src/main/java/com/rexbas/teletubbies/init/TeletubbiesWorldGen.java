...
public class TeletubbiesWorldGen {
	...
	public static final Supplier<StructureType<DomeStructure>> DOME_STRUCTURE = STRUCTURE_TYPES.register("dome_structure", () -> () -> DomeStructure.CODEC);
	
	// Features
	public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(Registries.FEATURE, Teletubbies.MODID);
	public static final Supplier<VoiceTrumpetFeature> VOICE_TRUMPET_FEATURE = FEATURES.register("voice_trumpet_feature", VoiceTrumpetFeature::new);
}