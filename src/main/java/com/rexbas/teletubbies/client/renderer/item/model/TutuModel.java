...
public class TutuModel extends BipedModel<LivingEntity> {
	...
	public void setupAnim(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		segment1.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment2.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment3.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment4.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment5.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment6.xRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);

		segment7.zRot = -0.3491F + f1 * MathHelper.cos(f2 * ageInTicks);
		segment8.zRot = 0.3491F - f1 * MathHelper.cos(f2 * ageInTicks);
	}
