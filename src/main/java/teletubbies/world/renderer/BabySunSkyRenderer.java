...
public class BabySunSkyRenderer extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		/*
		 * if (pass != 2) { float f3 = (f * 30.0F + f1 * 59.0F + f2 * 11.0F) /
		 * 100.0F; float f4 = (f * 30.0F + f1 * 70.0F) / 100.0F; float f5 = (f *
		 * 30.0F + f2 * 70.0F) / 100.0F; f = f3; f1 = f4; f2 = f5; }
		 */
		...
		if (afloat != null) {
			...
			/*
			 * if (pass != 2) { float f9 = (f6 * 30.0F + f7 * 59.0F + f8 *
			 * 11.0F) / 100.0F; float f10 = (f6 * 30.0F + f7 * 70.0F) / 100.0F;
			 * float f11 = (f6 * 30.0F + f8 * 70.0F) / 100.0F; f6 = f9; f7 =
			 * f10; f8 = f11; }
			 */
