...
public class EntityTeletubby extends EntityAnimal {
	...
	protected boolean shouldAddArmor = true;
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound) {
    	...
    	compound.setBoolean("shouldAddArmor", this.shouldAddArmor);
    	return compound;
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
    	...
    	this.shouldAddArmor = compound.getBoolean("shouldAddArmor");
    	if(this.shouldAddArmor) this.addArmor();
    }
}
