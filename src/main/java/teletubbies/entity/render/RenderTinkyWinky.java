...
public class RenderTinkyWinky extends RenderBiped<EntityTinkyWinky> {
	
    private final ModelBiped defaultModel;
    private final List<LayerRenderer<EntityTinkyWinky>> defaultLayers;

	public RenderTinkyWinky(RenderManager rendermanager, boolean isZombie, final float scale, float shadowsize) {
	...
	@Override
    public void doRender(EntityTinkyWinky entity, double x, double y, double z, float entityYaw, float partialTicks) {
    	this.swapArmor(entity);
    	super.doRender(entity, x, y, z, entityYaw, partialTicks);
	}
	
	private void swapArmor(EntityTinkyWinky entity) {
	...
	@Override
    protected void rotateCorpse(EntityTinkyWinky entityLiving, float f0, float f1, float partialTicks) {
        super.rotateCorpse((EntityTinkyWinky) entityLiving, f0, f1, partialTicks);
    }

	@Override
	protected ResourceLocation getEntityTexture(EntityTinkyWinky entity) {
		return new ResourceLocation("teletubbies:textures/entity/TinkyWinky.png");
	}
}
