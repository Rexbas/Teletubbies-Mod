...
public class ItemRenderTubbyCustardMachine implements IItemRenderer{

    ResourceLocation textures = (new ResourceLocation("teletubbies:textures/blocks/TubbyCustardMachine.png"));
	TileEntitySpecialRenderer render;
	private TileEntity te;
	protected ModelTubbyCustardMachine model;
	
	public ItemRenderTubbyCustardMachine(TileEntitySpecialRenderer render, TileEntity entity){
		this.te = entity;
		this.render = render;
		model = new ModelTubbyCustardMachine();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data){		
		if(type == IItemRenderer.ItemRenderType.ENTITY){
			if(RenderItem.renderInFrame){
		        ...
		        GL11.glPushMatrix(); 
		        this.model.render((Entity)null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.033F);        
		        GL11.glPopMatrix();            
		        GL11.glPopMatrix();  
		        GL11.glPopMatrix();
		        GL11.glPopMatrix();
