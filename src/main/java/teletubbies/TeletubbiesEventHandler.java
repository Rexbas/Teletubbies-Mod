...
public class TeletubbiesEventHandler {
	...
	public void onEntityJoinWorld(EntityJoinWorldEvent event) {
		if(event.entity instanceof EntityZombie && ConfigurationHandler.zombiesAttacksTeletubbies == true) {
	        ...
	        Zombie.targetTasks.addTask(2, new EntityAINearestAttackableTarget(Zombie, EntityPo.class, true));
	        Zombie.targetTasks.addTask(2, new EntityAINearestAttackableTarget(Zombie, EntityLaaLaa.class, true));
	        Zombie.targetTasks.addTask(2, new EntityAINearestAttackableTarget(Zombie, EntityDipsy.class, true));
	        Zombie.targetTasks.addTask(2, new EntityAINearestAttackableTarget(Zombie, EntityTinkyWinky.class, true));
		}
	}
