...
public class TeletubbiesEventHandler {
	...
	public void attachtCapability(AttachCapabilitiesEvent.Entity event) {		
		if(event.getEntity() instanceof EntityPlayer) {
			event.addCapability(new ResourceLocation(Teletubbies.MODID + ":TeletubbiesCap"), new Teletubbies_CAPProvider(event));
		}
	}
	...
	public void onLivingDeathEvent(LivingDeathEvent event) {
		...
		if(!world.isRemote) {
			if(damageSource.getEntity() instanceof EntityZombie) {
