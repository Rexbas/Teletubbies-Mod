...
public class ModelDipsy extends ModelBase {
	ModelRenderer body;
	...
	public ModelDipsy(boolean isZombie) {
	    ...
	    Piece1.mirror = true;
	      ...
	      stick1 = new ModelRenderer(this, 0, 31);
	      stick1.addBox(0F, 0F, 0F, 2, 5, 2);
	      stick1.setRotationPoint(-1F, -11F, -1F);
