...
public class DomePieces {
	...
	public static class Piece extends TemplateStructurePiece {
	    ...
	    @Override
	    public boolean addComponentParts(IWorld world, Random rand, MutableBoundingBox mbb, ChunkPos chunkPos) {
	    	boolean b = super.addComponentParts(world, rand, mbb, chunkPos);
