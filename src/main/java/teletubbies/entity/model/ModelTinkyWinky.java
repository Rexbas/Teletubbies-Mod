...
public class ModelTinkyWinky extends ModelBiped {
	...
	public ModelTinkyWinky(boolean isZombie, float scale) {
		...
		this.bipedHead.addChild(stick5);
		this.bipedHead.addChild(stick6);
