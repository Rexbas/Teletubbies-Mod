...
public class RenderDipsy extends RenderBiped<EntityDipsy> {
    ...
    private final List<LayerRenderer<EntityDipsy>> defaultLayers;
	...
	private void swapArmor(EntityDipsy entity) {
	...
	@Override
    protected void rotateCorpse(EntityDipsy entityLiving, float f0, float f1, float partialTicks) {
        super.rotateCorpse((EntityDipsy) entityLiving, f0, f1, partialTicks);
    }
