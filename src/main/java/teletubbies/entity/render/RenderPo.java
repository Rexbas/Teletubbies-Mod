...
public class RenderPo extends RenderBiped<EntityPo> {
    ...
    private final List<LayerRenderer<EntityPo>> defaultLayers;
	...
	private void swapArmor(EntityPo entity) {
	...
	@Override
    protected void rotateCorpse(EntityPo entityLiving, float f0, float f1, float partialTicks) {
        super.rotateCorpse((EntityPo) entityLiving, f0, f1, partialTicks);
    }
